	...
	protected void initializeView() {
		...
		btnInsertNewVisitResult.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(email != null)
					JOptionPane.showMessageDialog(null, "Il risultato della vista � stato inserito correttamente.\nUna mail di notifica e' stata inviata all'indirizzo: " + email,"Informazione", JOptionPane.INFORMATION_MESSAGE);
				else
					JOptionPane.showMessageDialog(null, "Il risultato della vista � stato inserito correttamente.","Informazione", JOptionPane.INFORMATION_MESSAGE);
